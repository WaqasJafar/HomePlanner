...
public class secoundfloor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secoundfloor);
        ...
        if (FloorName.equals("Enter the First Floor Dimensions")|FloorName.equals("Enter the Secound Floor Dimensions")){
            garageportion.removeAllViews();
        }

        SharedPreferences preferences =secoundfloor.this.getSharedPreferences(My_Estimator_name, Context.MODE_PRIVATE);
...
//floorheight dropdown
        ArrayAdapter<String> flooradapter = new ArrayAdapter<String>(secoundfloor.this,
...
//room1 dropdown
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(secoundfloor.this,
...
//room2 dropdown
        ArrayAdapter<String> roomadapter2 = new ArrayAdapter<String>(secoundfloor.this,
        ...
        //room3 dropdown
        ArrayAdapter<String> roomadapter3 = new ArrayAdapter<String>(secoundfloor.this,
        ...
        //kitchen dropdown
        ArrayAdapter<String> kitchenadapter = new ArrayAdapter<String>(secoundfloor.this,
        ...
        //tv dropdown
        ArrayAdapter<String> tvadapter = new ArrayAdapter<String>(secoundfloor.this,
        ...
        //bath dropdown
        ArrayAdapter<String> bathadapter = new ArrayAdapter<String>(secoundfloor.this,
        ...
        //garage dropdown
        ArrayAdapter<String> garageadapter = new ArrayAdapter<String>(secoundfloor.this,
        ...
        roomdecrease2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roominteger2>0){
                    ...
                    Toast.makeText(secoundfloor.this, "Room Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        kitchendecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kicheninteger>0){
                    ...
                    Toast.makeText(secoundfloor.this, "Kitchen Value is Already 0", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        bathdecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bathinteger>0){
                    ...
                    Toast.makeText(secoundfloor.this, "Bathroom Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        tvdecrese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvinteger>0){
                    ...
                    Toast.makeText(secoundfloor.this, "TV Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        garagedecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (garageinteger>0){
                    ...
                    Toast.makeText(secoundfloor.this, "Garage Value is Already 0", Toast.LENGTH_SHORT).show();
                }
...
//garage
                ...
                Toast.makeText(secoundfloor.this, ""+roomtotal, Toast.LENGTH_SHORT).show();
//                    //4.5inchwall
...
//cement calculation
                    ...
                    int alltotal = room1sq+room2sq+room3sq + kitchensq + tvsq + bathsq + garagesq;
                   ...
                   double floorcement=roomcement+kitchencement+tvcement+bathcement+garagecement;
                    ...
                    Toast.makeText(secoundfloor.this, ""+floorsand, Toast.LENGTH_SHORT).show();
...
//                        totalcement=floorcementg+floorcement1+floorcement;
                        ...
                        editor.putInt("secoundfloorbrick", (int) floorbrick);
                        editor.putInt("secoundfloorcement",(int) floorcement);
                        editor.putInt("secoundfloorsand",(int) floorsand);
                        editor.apply();
                    }
        ...
        btnafterestimate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(secoundfloor.this,MaterialCalculator.class);
