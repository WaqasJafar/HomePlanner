...
public class GroundFloor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferences =GroundFloor.this.getSharedPreferences(My_Estimator_name, Context.MODE_PRIVATE);
...
//floorheight dropdown
        ArrayAdapter<String> flooradapter = new ArrayAdapter<String>(GroundFloor.this,
...
//room1 dropdown
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(GroundFloor.this,
...
//room2 dropdown
        ArrayAdapter<String> roomadapter2 = new ArrayAdapter<String>(GroundFloor.this,
        ...
        //room3 dropdown
        ArrayAdapter<String> roomadapter3 = new ArrayAdapter<String>(GroundFloor.this,
        ...
        //kitchen dropdown
        ArrayAdapter<String> kitchenadapter = new ArrayAdapter<String>(GroundFloor.this,
        ...
        //tv dropdown
        ArrayAdapter<String> tvadapter = new ArrayAdapter<String>(GroundFloor.this,
        ...
        //bath dropdown
        ArrayAdapter<String> bathadapter = new ArrayAdapter<String>(GroundFloor.this,
        ...
        //garage dropdown
        ArrayAdapter<String> garageadapter = new ArrayAdapter<String>(GroundFloor.this,
        ...
        roomdecrease2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roominteger2>0){
                    ...
                    Toast.makeText(GroundFloor.this, "Room Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        kitchendecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kicheninteger>0){
                    ...
                    Toast.makeText(GroundFloor.this, "Kitchen Value is Already 0", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        bathdecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bathinteger>0){
                    ...
                    Toast.makeText(GroundFloor.this, "Bathroom Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        tvdecrese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvinteger>0){
                    ...
                    Toast.makeText(GroundFloor.this, "TV Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        garagedecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (garageinteger>0){
                    ...
                    Toast.makeText(GroundFloor.this, "Garage Value is Already 0", Toast.LENGTH_SHORT).show();
                }
...
//cement calculation
                    ...
                    if (alltotal > plotsquare) {
                        ...
                        editor.putInt("groundfloorcement",(int) floorcement);
                        editor.putInt("groundfloorsand",(int) floorsand);
                        editor.putInt("groundfloorbrick", (int) floorbrick);
                        editor.apply();
                    }
        ...
        btnafterestimate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GroundFloor.this,firstfloor.class);
                intent.putExtra("FloorName", "Enter the First Floor Dimensions");
