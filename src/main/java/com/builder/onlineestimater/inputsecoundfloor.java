...
public class inputsecoundfloor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inputsecoundfloor);
        ...
        SharedPreferences preferences =inputsecoundfloor.this.getSharedPreferences(My_Estimator_name, Context.MODE_PRIVATE);
...
//floorheight dropdown
        ArrayAdapter<String> flooradapter = new ArrayAdapter<String>(inputsecoundfloor.this,
        ...
        roomdecrease2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roominteger2>0){
                    ...
                    Toast.makeText(inputsecoundfloor.this, "Room Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        kitchendecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kicheninteger>0){
                    ...
                    Toast.makeText(inputsecoundfloor.this, "Kitchen Value is Already 0", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        bathdecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bathinteger>0){
                    ...
                    Toast.makeText(inputsecoundfloor.this, "Bathroom Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        tvdecrese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvinteger>0){
                    ...
                    Toast.makeText(inputsecoundfloor.this, "TV Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        garagedecrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (garageinteger>0){
                    ...
                    Toast.makeText(inputsecoundfloor.this, "Garage Value is Already 0", Toast.LENGTH_SHORT).show();
                }
        ...
        estimate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (kitchenl.getText().toString().equals("") | kitchenw.getText().toString().equals("") | rooml.getText().toString().equals("") | roomw.getText().toString().equals("") | bathl.getText().toString().equals("") | bathw.getText().toString().equals("") | tvl.getText().toString().equals("") | tvw.getText().toString().equals("") | garagel.getText().toString().equals("") | garagew.getText().toString().equals("")| rooml2.getText().toString().equals("") | roomw2.getText().toString().equals("")| rooml3.getText().toString().equals("") | roomw3.getText().toString().equals("")) {
                    Toast.makeText(inputsecoundfloor.this, "Please Fill All the Inputs if you want ignore something place 0 ", Toast.LENGTH_SHORT).show();
                }
                if (!kitchenl.getText().toString().equals("") && !kitchenw.getText().toString().equals("") && !rooml.getText().toString().equals("") && !roomw.getText().toString().equals("") && !bathl.getText().toString().equals("") && !bathw.getText().toString().equals("") && !tvl.getText().toString().equals("") && !tvw.getText().toString().equals("") && !garagel.getText().toString().equals("") && !garagew.getText().toString().equals("")&& !rooml2.getText().toString().equals("") && !roomw2.getText().toString().equals("")&& !rooml3.getText().toString().equals("") && !roomw3.getText().toString().equals("")) {
                    if (floorheightpos==0){
                        height=12;
                    ...
                    Toast.makeText(inputsecoundfloor.this, ""+roomtotal1, Toast.LENGTH_SHORT).show();
...
//                        totalcement=floorcementg+floorcement1+floorcement;
        ...
        btnafterestimate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(inputsecoundfloor.this,MaterialCalculator.class);
